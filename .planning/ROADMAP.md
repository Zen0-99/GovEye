...
- [x] 18-01: Python parser + DB schema for 16 structured interest fields (wave 1)
- [x] 18-02: Android entity + Room migration v23→v24 + domain model + mapper (wave 1, depends on 18-01)
- [x] 18-03: Card UI integration — structured fields in feed, activity, and detail cards (wave 2, depends on 18-02)
