...
/**
 * Monet color scheme — dynamic wallpaper-based colors (D-06).
 *
 * Simplified from Miko's Monet: uses system [dynamicLightColorScheme] /
 * [dynamicDarkColorScheme] on API 31+ (Android S). On older APIs (minSdk 26),
 * falls back to [CoralColorScheme] (the default). No material-color-utilities
 * dependency — just the platform API + fallback.
 */
